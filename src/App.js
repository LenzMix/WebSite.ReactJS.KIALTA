...
class App extends Component {
  ...
  hLawers() {
    ...
    console.log('Запрос на отрисовку юристов');
  }
  ...
  hAuth() {
    ...
    else window.location.hash='Authorization';
  }
    ...
    return (
      ...
      <div className={'App'} onLoad={this.socketListener()}>
        ...
        <header className={'header'}>
          <div className={'header-block'}>
            <div className={'logo'} onClick={this.hMain}>
              ...
              <div className={'logodown'}>ЮРИДИЧЕСКАЯ КОМПАНИЯ</div>
            </div>
        ...
        <div className={'footer'}>
          <div className={'footer-left'}><YMInitializer accounts={[619976,  66386782]} options={{webvisor: true, defer: true, clickmap: true, triggerEvent: true}} version="2" /></div>
          <div className={'footer-right'}>КИАЛТА | 2020 год</div>
